...
* Project Page: http://www.siyelo.com/community/
...
These templates are included, but not installed by default (nor tested). Manually edit template.rb to include them.
